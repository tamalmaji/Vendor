            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 mb-40">
                    <form action="#">
                        ...
                        <h3>
                            <input id="ship_form" type="checkbox" data-bs-target="shipping_form" />
                ...
                <div class="col-xl-6 col-lg-6 col-12 mb-40">
                            ...
                            <div class="panel-group" id="accordion">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" id="headingTwo">
                                        <h4 class="panel-title mb-0">
                                            <a class="collapsed" data-bs-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                            Cheque Payment
                                            </a>
                                        </h4>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" id="headingThree">
                                        <h4 class="panel-title mb-0">
                                            <a class="collapsed" data-bs-toggle="collapse" data-parent="#accordion" href="#collapseThree">
                                            PayPal
                                            </a>
                                        </h4>
                                    </div>
