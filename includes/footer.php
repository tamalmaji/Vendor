	...
	<div class="container">
		<div class="row">
			...
			<div class="footer-widget link-widget col-lg-3 col-md-6 col-12 mb-8">
				...
				<ul>
					<li><a href="registerphp">My Account</a></li>
					<li><a href="wishlistphp">My Wishlist</a></li>
					<li><a href="cartphp">My Cart</a></li>
					<li><a href="loginphp">Sign In</a></li>
					<li><a href="checkoutphp">Check out</a></li>
				</ul>
			</div>
			<!-- Footer Widget -->
			<div class="footer-widget col-lg-3 col-md-6 col-12 mb-8">
				...
				<div class="tag-cloud fix">
				    <a href="shopphp">brand</a>
				    <a href="shopphp">fashion</a>
				    <a href="shopphp">sale</a>
				    <a href="shopphp">winter sale</a>
				    <a href="shopphp">summer sale</a>
				    <a href="shopphp">men</a>
				    <a href="shopphp">women</a>
				    <a href="shopphp">kids</a>
				</div>
			</div>
			<!-- Footer Widget -->
			<div class="footer-widget col-lg-3 col-md-6 col-12 mb-8">
	...
	<div class="container">
		<div class="row">
			...
			<div class="copyright text-center text-md-start col-md-6 col-12">
				<p>© 2022 Furnish. Made with <i class="fa fa-heart heart-icon"></i> By <a target="_blank" href="https://hasthemes.com">HasThemes</a></p>
			</div>
			<!-- Payment Method -->
