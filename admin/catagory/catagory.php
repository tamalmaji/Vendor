...
$sql = 'SELECT * FROM vendor_catagory';
if ($statement = $pdo->prepare($sql)) {
  if ($statement->execute()) {
    ...
    $sqli = "SELECT * FROM vendor_catagory LIMIT $start_from, $no_per_page";
...
<div class="content-wrapper">
  ...
  <div class="container">
    <div class="row">
      <div class="col-12">
        <a href="add.php" class="btn btn-outline-primary btn-sm">Add Catagory</a>
        <br>
        <br>
      </div>
      <div class="col-12">
            ...
            <table class="table table-hover text-nowrap">
              ...
              <tbody>
                <?php foreach ($catagorys as $i => $catagory) : ?>
                  <tr>
                    <td><?php echo $i + 1 ?></td>
                    <td><?php echo $catagory['catagory_title'] ?></td>
                    <td><?php echo $catagory['create_at'] ?></td>
                    <td>
                      <a href="update.php?id=<?php echo $catagory['catagory_id'] ?>" class="btn btn-info btn-xs">Edit</a>
