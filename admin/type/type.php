<?php
  require_once "../function/type/_type.php";
?>
...
<div class="content-wrapper">
  ...
  <div class="container">
    <div class="row">
      <div class="col-12">
        <a href="add.php" class="btn btn-outline-primary btn-sm">Add Type</a>
        <br>
        <br>
      </div>
      <div class="col-12">
            ...
            <table class="table table-hover text-nowrap">
              ...
              <tbody>
                <?php foreach ($types as $i => $type) : ?>
                  <tr>
                    <td><?php echo $i + 1 ?></td>
                    <td><?php echo $type['for_title'] ?></td>
                    <td><?php echo $type['create_at'] ?></td>
                    <td>
                      <a href="update.php?id=<?php echo $type['for_id'] ?>" class="btn btn-info btn-xs">Edit</a>
                      <form action="delete.php" method="POST" style="display: inline-block;">
                        <input type="hidden" name="id" value="<?php echo $type['for_id'] ?>">
