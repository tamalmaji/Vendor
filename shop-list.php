            ...
            <div class="col-xl-9 col-lg-8 col-12 order-lg-1 order-0">
                <div class="shop-bar mb-30">
                    <ul class="shop-tablist nav">
                        ...
                        <li><a class="active" href="#product-list" data-bs-toggle="tab"><i class="fa fa-list"></i></a></li>
                    </ul>
                    ...
                    <div class="tab-pane" id="product-grid">
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-12 mb-8">
                                <div class="product-item text-center">
                                    <div class="product-img">
                                        <a class="image" href="product-details.php"><img src="img/product/1.jpg" alt="Image"/></a>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-12 mb-8">
                                <div class="product-item text-center">
                                    <div class="product-img">
                                        <a class="image" href="product-details.php"><img src="img/product/2.jpg" alt="Image"/></a>
                                        <a href="cart.php" class="add-to-cart">add to cart</a>
                                        <div class="action-btn fix">
                                            <a href="wishlist.php" title="Wishlist"><i class="pe-7s-like"></i></a>
                                            <a href="product-details.php" title="Quickview"><i class="pe-7s-look"></i></a>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-12 mb-8">
                                <div class="product-item text-center">
                                    <div class="product-img">
                                        <a class="image" href="product-details.php"><img src="img/product/3.jpg" alt="Image"/></a>
                                        <a href="cart.php" class="add-to-cart">add to cart</a>
                                        <div class="action-btn fix">
                                            <a href="wishlist.php" title="Wishlist"><i class="pe-7s-like"></i></a>
                                            <a href="product-details.php" title="Quickview"><i class="pe-7s-look"></i></a>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-12 mb-8">
                                <div class="product-item text-center">
                                    <div class="product-img">
                                        <a class="image" href="product-details.php"><img src="img/product/4.jpg" alt="Image"/></a>
                                        <a href="cart.php" class="add-to-cart">add to cart</a>
                                        <div class="action-btn fix">
                                            <a href="wishlist.php" title="Wishlist"><i class="pe-7s-like"></i></a>
                                            <a href="product-details.php" title="Quickview"><i class="pe-7s-look"></i></a>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-12 mb-8">
                                <div class="product-item text-center">
                                    <div class="product-img">
                                        <a class="image" href="product-details.php"><img src="img/product/5.jpg" alt="Image"/></a>
                                        <a href="cart.php" class="add-to-cart">add to cart</a>
                                        <div class="action-btn fix">
                                            <a href="wishlist.php" title="Wishlist"><i class="pe-7s-like"></i></a>
                                            <a href="product-details.php" title="Quickview"><i class="pe-7s-look"></i></a>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-12 mb-8">
                                <div class="product-item text-center">
                                    <div class="product-img">
                                        <a class="image" href="product-details.php"><img src="img/product/6.jpg" alt="Image"/></a>
                                        <a href="cart.php" class="add-to-cart">add to cart</a>
                                        <div class="action-btn fix">
                                            <a href="wishlist.php" title="Wishlist"><i class="pe-7s-like"></i></a>
                                            <a href="product-details.php" title="Quickview"><i class="pe-7s-look"></i></a>
                                    ...
                                    <div class="product-info">
                                        <h5 class="title"><a href="product-details.php">Retro chairs</a></h5>
                                        <span class="price"><span class="new">$169.00</span></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-12 mb-8">
                                <div class="product-item text-center">
                                    <div class="product-img">
                                        <a class="image" href="product-details.php"><img src="img/product/7.jpg" alt="Image"/></a>
                                        <a href="cart.php" class="add-to-cart">add to cart</a>
                                        <div class="action-btn fix">
                                            <a href="wishlist.php" title="Wishlist"><i class="pe-7s-like"></i></a>
                                            <a href="product-details.php" title="Quickview"><i class="pe-7s-look"></i></a>
                                    ...
                                    <div class="product-info">
                                        <h5 class="title"><a href="product-details.php">kichler pendant light</a></h5>
                                        <span class="price"><span class="new">$185.00</span><span class="old">$125..00</span></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-12 mb-8">
                                <div class="product-item text-center">
                                    <div class="product-img">
                                        <a class="image" href="product-details.php"><img src="img/product/8.jpg" alt="Image"/></a>
                                        <a href="cart.php" class="add-to-cart">add to cart</a>
                                        <div class="action-btn fix">
                                            <a href="wishlist.php" title="Wishlist"><i class="pe-7s-like"></i></a>
                                            <a href="product-details.php" title="Quickview"><i class="pe-7s-look"></i></a>
                                    ...
                                    <div class="product-info">
                                        <h5 class="title"><a href="product-details.php">pendant lights</a></h5>
                                        <span class="price"><span class="new">$245.00</span></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-12 mb-8">
                                <div class="product-item text-center">
                                    <div class="product-img">
                                        <a class="image" href="product-details.php"><img src="img/product/9.jpg" alt="Image"/></a>
                                        <a href="cart.php" class="add-to-cart">add to cart</a>
                                        <div class="action-btn fix">
                                            <a href="wishlist.php" title="Wishlist"><i class="pe-7s-like"></i></a>
                                            <a href="product-details.php" title="Quickview"><i class="pe-7s-look"></i></a>
                                    ...
                                    <div class="product-info">
                                        <h5 class="title"><a href="product-details.php">midcentury pendant light</a></h5>
                                        <span class="price"><span class="new">$245.00</span></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 mb-40">
                                <div class="list-product-item">
                                    ...
                                    <div class="list-product-info fix">
                                        <h2 class="title"><a href="product-details.php">Le Parc Minotti Chair</a></h2>
                                        <span class="price"><span class="new">$169.00</span></span>
                            ...
                            <div class="col-xs-12 mb-40">
                                <div class="list-product-item">
                                    ...
                                    <div class="list-product-info fix">
                                        <h2 class="title"><a href="product-details.php">DSR Eiffel chair</a></h2>
                                        <span class="price"><span class="new">$137.00</span><span class="old">$115.00</span></span>
                                        <p>Investigationes demonstraverunt lectores legere me lius quod ii legunt saepius. Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram.</p>
                                        <div class="list-action-btn fix">
                                            <a href="cart.php" class="add-to-cart">add to cart</a>
                            ...
                            <div class="col-xs-12 mb-40">
                                <div class="list-product-item">
                                    ...
                                    <div class="list-product-info fix">
                                        <h2 class="title"><a href="product-details.php">3d laser cut models</a></h2>
                                        <span class="price"><span class="new">$185.00</span><span class="old">$125..00</span></span>
                                        <p>Investigationes demonstraverunt lectores legere me lius quod ii legunt saepius. Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram.</p>
                                        <div class="list-action-btn fix">
                                            <a href="cart.php" class="add-to-cart">add to cart</a>
                            ...
                            <div class="col-xs-12 mb-40">
                                <div class="list-product-item">
                                    ...
                                    <div class="list-product-info fix">
                                        <h2 class="title"><a href="product-details.php">carl hansen ch25</a></h2>
                                        <span class="price"><span class="new">$245.00</span></span>
                                        <p>Investigationes demonstraverunt lectores legere me lius quod ii legunt saepius. Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram.</p>
                                        <div class="list-action-btn fix">
                                            <a href="cart.php" class="add-to-cart">add to cart</a>
                            ...
                            <div class="col-xs-12 mb-40">
                                <div class="list-product-item">
                                    ...
                                    <div class="list-product-info fix">
                                        <h2 class="title"><a href="product-details.php">Retro chairs</a></h2>
                                        <span class="price"><span class="new">$169.00</span></span>
                                        <p>Investigationes demonstraverunt lectores legere me lius quod ii legunt saepius. Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram.</p>
                                        <div class="list-action-btn fix">
                                            <a href="cart.php" class="add-to-cart">add to cart</a>
            ...
            <div class="col-xl-3 col-lg-4 col-12 order-lg-0 order-1">
                ...
                <div class="single-sidebar mb-8">
                    ...
                    <ul class="category-sidebar">
                        <li><a href="shop.php">Chairs</a></li>
                        <li><a href="shop.php">Tables</a></li>
                        <li><a href="shop.php">Sofas</a></li>
                        <li><a href="shop.php">Lights & Lamps</a></li>
                        <li><a href="shop.php">Decorations</a></li>
                ...
                <div class="single-sidebar mb-8">
                    ...
                    <div class="tag-cloud">
                        <a href="shop.php">Chairs</a>
                        <a href="shop.php">Tables</a>
                        <a href="shop.php">Sofas</a>
                        <a href="shop.php">Lights</a>
                        <a href="shop.php">Lamps</a>
                        <a href="shop.php">curtains</a>
                        <a href="shop.php">cabinets</a>
                    </div>
                </div>
